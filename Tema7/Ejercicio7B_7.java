...
public class Ejercicio7B_7{
  ...
  public static void main(String[] args) {
    ...
    for(y = 3; y >= 0; y--) {
      ...
      if (cuadrante[x-1][y] == cuadrante[minaX][minaY]){
      System.out.println("¡Cuidado! ¡Hay una mina cerca!");    
    }else if (cuadrante[x][y-1] == cuadrante[minaX][minaY]){
      System.out.println("¡Cuidado! ¡Hay una mina cerca!");
      }else if (cuadrante[x+1][y] == cuadrante[minaX][minaY]){
        System.out.println("¡Cuidado! ¡Hay una mina cerca!");
        }else if (cuadrante[x][y+1] == cuadrante[minaX][minaY]){
          System.out.println("¡Cuidado! ¡Hay una mina cerca!");
          }else if (cuadrante[x+1][y-1] == cuadrante[minaX][minaY]){
            System.out.println("¡Cuidado! ¡Hay una mina cerca!");
            }else if (cuadrante[x+1][y+1] == cuadrante[minaX][minaY]){
              System.out.println("¡Cuidado! ¡Hay una mina cerca!");
              }else if (cuadrante[x-1][y-1] == cuadrante[minaX][minaY]){
